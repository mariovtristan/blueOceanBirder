...
5. Chat functionality currently works in localhost, as with the implementation of Auth0, the sockets weren't able to bypass connectivity to outside users.
